<template>
  <div class="scroll-y">
    ...
    <div class="mr-3 rowSS">
      ...
      <div class="ml-4">
        <ImportExportComp
          import-file-url="/vci/importExcel"
          import-valid-url="/vci/validExcel"
          export-file-url="/vci/exportExcel"
...
const downloadTemplate = () => {
  ...
  // link.href = 'http://titan/file/template/xxxx.xlsx'
