  ...
  data() {
    ...
    return {
      ...
      formRulesMixin: {
        ...
        isNotNullCheckbox: [{ required: true, message: '请选择', trigger: 'change' }],
        isNotNullLine: [{ required: true, message: ' ', trigger: 'blur' }],
        isNotNullSelect: [{ required: true, message: ' ', trigger: 'change' }],
        mLength8: [
